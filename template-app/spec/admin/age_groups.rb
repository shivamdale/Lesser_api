...
RSpec.describe Admin::AgeGroupsController, type: :controller do 
  render_views
  before(:each) do
    ...
    @admin.save
    sign_in @admin
    @age_group = AccountBlock::AgeGroup.create(title: Faker::Name.name)
  end
  ...
  describe "Get#show" do
    it "show single data" do
       get :show, params: {id: @age_group.id}
       expect(response).to have_http_status(200)
    end
  end
  ...
  describe "Put,edit,delete" do
    ...
    describe "Put,edit" do
      it "edit accounts" do
        put :edit, params: {id: @age_group.id}
        expect(response).to have_http_status(200)
      end
    end
    ...
    describe "Put,delete" do
      it "delete account" do
        delete :destroy, params: {id: @age_group.id}
