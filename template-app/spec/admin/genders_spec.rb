...
RSpec.describe Admin::GendersController, type: :controller do 
  render_views
  before(:each) do
    ...
    @admin.save
    sign_in @admin
    @gender = AccountBlock::Gender.create(title: Faker::Name.name)
  end
  ...
  describe "Put,edit,delete" do
    ...
    describe "Put,delete" do
      it "delete account" do
        delete :destroy, params: {id: @gender.id}
